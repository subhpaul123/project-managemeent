    ...
    <div className={sidebarClassNames}>
      <div className="flex h-[100%] w-full flex-col justify-start">
        ...
        <div className="flex items-center gap-5 border-y-[1.5px] border-gray-200 px-8 py-4 dark:border-gray-700">
          <Image src="https://pm-s3-images1234.s3.eu-north-1.amazonaws.com/logo.png" alt="Logo" width={40} height={40} />
          <div>
        ...
        <nav className="z-10 w-full">
          <SidebarLink icon={House} label="Home" href="/" />
      ...
      <div className="z-10 mt-32 flex w-full flex-col items-center gap-4 bg-white px-8 py-4 dark:bg-black md:hidden">
        <div className="flex w-full items-center">
          <div className="align-center flex h-9 w-9 justify-center">
            <Image src="https://pm-s3-images1234.s3.eu-north-1.amazonaws.com/p1.jpg" alt="User Profile Picture" width={100} height={50} className="h-full rounded-full object-cover" />
          </div>
